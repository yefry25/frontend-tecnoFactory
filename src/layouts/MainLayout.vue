<template>
    <q-layout view="lHh lpr lFf" class="font">
      ...
      <q-drawer v-model="leftDrawerOpen" side="left" behavior="mobile" bordered>
        <q-item clickable @click="routes.push('/Inicio')" v-if="store.token != undefined">
        ...
        <q-item clickable @click="routes.push('/Login')">
          <q-item-section avatar>
      ...
      <q-footer class="text-white" style="background-color: #202020;">
        <q-toolbar>
